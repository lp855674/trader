...
impl BayesianOptimizer {
        ...
        F: FnMut(&HashMap<String, f64>) -> f64,
    {
        ...
        let best = self.observations.iter().max_by(|a, b| {
            a.score
                .partial_cmp(&b.score)
                .unwrap_or(std::cmp::Ordering::Equal)
        });
...
mod tests {
    ...
    fn runs_n_initial_random_trials() {
        ...
        let mut opt =
            BayesianOptimizer::new(space, AcquisitionFunction::ExpectedImprovement, 5, 10);
    ...
    fn early_stopping_triggers_when_flat() {
        let space = make_space();
        let mut opt =
            BayesianOptimizer::new(space, AcquisitionFunction::ExpectedImprovement, 3, 10);
    ...
    fn bayesian_finds_optimum() {
        ...
        let mut opt =
            BayesianOptimizer::new(space, AcquisitionFunction::ExpectedImprovement, 3, 20);
