...
try {
    ...
    Assert-True ($cliReconciliation.Contains("reconciliation_audits=")) "expected CLI reconciliation audit count"
    Assert-True ($cliReconciliation.Contains("latest_audit_broker=simulated")) "expected CLI latest reconciliation audit broker"
    Assert-True ($cliReconciliation.Contains("latest_audit_account=paper")) "expected CLI latest reconciliation audit account"
    Assert-True ($cliReconciliation.Contains("latest_audit_severity=")) "expected CLI latest reconciliation audit severity"
