...
```powershell
.\scripts\reconciliation\production-reconciliation-soak.ps1 `
  -Broker ibkr `
  -Iterations 1 `
  -DelaySeconds 0 `
  -AccountId DU... `
...
- Production wrapper summary: `data/reconciliation/production/production-reconciliation-ibkr-3408ad3ffecc/summary.json`
- Production wrapper log: `data/reconciliation/production/production-reconciliation-ibkr-3408ad3ffecc/iteration-1.log`
...
- Production wrapper summary: `data/reconciliation/production/production-reconciliation-ibkr-c6364318447d/summary.json`
...
- Production wrapper summary: `data/reconciliation/production/production-reconciliation-ibkr-d7e9c0474e72/summary.json`
