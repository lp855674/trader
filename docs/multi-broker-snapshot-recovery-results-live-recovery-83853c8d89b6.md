...
- Status: completed
- Failure class: ok
- Evidence directory: `data/live-recovery-verification/live-recovery-83853c8d89b6/`
...
- `powershell -ExecutionPolicy Bypass -File .\scripts\verify.ps1`: exit 0.
- `powershell -ExecutionPolicy Bypass -File .\scripts\clippy.ps1`: exit 0 with existing warnings.
...
- `powershell -ExecutionPolicy Bypass -File .\scripts\check-db-boundary.ps1`: exit 0.
- `powershell -ExecutionPolicy Bypass -File .\scripts\check-storage-dto-boundary.ps1`: exit 0.
- `powershell -ExecutionPolicy Bypass -File .\scripts\check-api-read-model-boundary.ps1`: exit 0.
