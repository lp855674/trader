...
```powershell
powershell -ExecutionPolicy Bypass -Command "& .\scripts\reconciliation\live-reconciliation-gate.ps1 -Config 'configs/paper/ibkr_aapl_1d_parquet.toml' -Account @('ibkr:DU****91','binance:paper') -MinSuccessfulAudits 3 -MaxAuditAgeMs 300000"
```
...
- Result document: `docs/results/live-reconciliation/live-reconciliation-gate-results-real-broker-replay-2026-07-08.md`
...
- Result document: `docs/results/live-reconciliation/live-reconciliation-gate-results-fresh-readonly-2026-07-08.md`
...
```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\reconciliation\live-reconciliation-gate-evidence-aggregate.ps1 `
  -IbkrSummary data\reconciliation\production\<IBKR_SOAK_ID>\summary.json `
  -IbkrAccount DU****91 `
...
```powershell
powershell -ExecutionPolicy Bypass -Command "& .\scripts\reconciliation\live-reconciliation-gate.ps1 -Config 'data/reconciliation/live-gate-replay/gate-evidence-fresh-readonly-<DATE>.toml' -Account @('ibkr:DU****91','binance:binance-testnet') -MinSuccessfulAudits 3 -MaxAuditAgeMs 300000"
```
...
- Result document: `docs/results/live-reconciliation/live-reconciliation-gate-results-long-readonly-2026-07-08.md`
