...
```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\reconciliation\production-reconciliation-soak.ps1 -Broker ibkr -Iterations 6 -DelaySeconds 10 -ReadOnly -AccountId DU... -GatewayHost 127.0.0.1 -Port 4002 -ClientId 1
```

## Order-Recovery Soak

```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\reconciliation\production-reconciliation-soak.ps1 -Broker ibkr -Iterations 3 -DelaySeconds 10 -AccountId DU... -GatewayHost 127.0.0.1 -Port 4002 -ClientId 1
```
